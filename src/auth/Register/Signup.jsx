    ...
    <div className={styles.body}>
        ...
        <div className={styles.right}>
            ...
            <form className={styles.data} onSubmit={(event)=>validateForm(event,emailValue,passValue,passValue2,navigate)} id="forms">
              <label for="email" className={styles.dataLabel}>Email or phone</label>
              <div className={styles.dataBox}>
                <input type="email" id="email" ref={emailValue} className={styles.input}/>
              </div>
              <label for="password" className={styles.dataLabel}>Password</label>
              <div className={styles.dataBox}>
              ...
              <label for="password2" className={styles.dataLabel}>Re-enter Password</label>
              <div className={styles.dataBox}>
